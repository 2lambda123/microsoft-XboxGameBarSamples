...
// in users (A;;0x11;;;WD)  Allow SDDL_EVERYONE
// S-1-15-2-1714399563-1326177402-2048222277-143663168-2151391019-765408921-4098702777
// is this package (Microsoft.XboxGamingOverlay) SID
const wchar_t *const c_ComSecurityDescriptor =
    L"O:PSG:BUD:(A;;11;;;WD)(A;;11;;;S-1-15-2-4028404679-3178261574-3795030958-"
    L"2183307115-4290976547-500102433-721774397)S:(ML;;NX;;;LW)";
...
HRESULT InitializeComSecurity() {
  ...
  MakeAbsoluteSD(securityDescriptor.get(), nullptr, &headerSize, nullptr,
                 &daclSize, nullptr, &saclSize, nullptr, &ownerSize, nullptr,
                 &groupSize);
  ...
  wil::unique_hlocal_security_descriptor absoluteSd(
      reinterpret_cast<SECURITY_DESCRIPTOR *>(
          LocalAlloc(LMEM_FIXED, totalSize)));
  ...
  RETURN_IF_WIN32_BOOL_FALSE(MakeAbsoluteSD(
      securityDescriptor.get(), absoluteSd.get(), &headerSize, dacl, &daclSize,
      sacl, &saclSize, owner, &ownerSize, group, &groupSize));

  RETURN_IF_FAILED(CoInitializeSecurity(
      absoluteSd.get(), -1, nullptr, nullptr, RPC_C_AUTHN_LEVEL_DEFAULT,
...
int __stdcall wWinMain(HINSTANCE, HINSTANCE, LPWSTR, int) {
  ...
  try {
    traceFolder = winrt::Windows::Storage::ApplicationData::Current()
                      .TemporaryFolder()
                      .Path();
  ...
  // Utils::TraceManager::SetupTracing(traceFolder.data(),
  // Utils::TraceFileProcess::WidgetFTServer); // It's ok to pass empty
  // traceFolder. Utils::TraceManager::ToggleFileTracing(true);
