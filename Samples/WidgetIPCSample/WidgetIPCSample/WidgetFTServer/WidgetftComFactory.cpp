...
class WidgetftComFactory
    : public Microsoft::WRL::RuntimeClass<
          ...
          IActivationFactory> {
  STDMETHODIMP
  ActivateInstance(__RPC__deref_out_opt IInspectable **instance) noexcept try {
    THROW_HR_IF_NULL(E_POINTER, instance);
    auto factory = winrt::make_self<
        winrt::WidgetFTServer::implementation::WidgetftFactory>();
